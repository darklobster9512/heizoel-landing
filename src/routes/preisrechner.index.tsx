    ...
    >
      ...
      <div key={orderKey} className="animate-fade-in relative px-4 py-3.5">
        <div className="grid grid-cols-[minmax(0,1fr)_auto] items-start gap-3 sm:flex sm:items-center sm:justify-between">
          ...
          <Logo className="h-auto w-[92px] shrink-0 text-brand-logo" />
        </div>
          ...
          <div className="mx-auto max-w-5xl px-4 py-8 sm:px-5 md:py-16">
            ...
            <div className="w-full min-w-0 rounded-xl border border-line bg-background shadow-card">
              <div className="grid min-w-0 lg:grid-cols-2">
                ...
                <div className="min-w-0 rounded-b-xl border-t border-line bg-surface/50 p-4 min-[390px]:p-6 md:p-10 lg:rounded-bl-none lg:rounded-r-xl lg:border-t-0 lg:border-l">
                  <CompactSteps />
                </div>
              </div>
            </div>
