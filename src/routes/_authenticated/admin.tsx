    ...
    >
      {!isAdmin ? (
        ...
        <>
          ...
          <div className="mt-6 flex gap-2 overflow-x-auto border-b border-[#e5e7eb] [scrollbar-width:none] [&::-webkit-scrollbar]:hidden">
            {(
              [
                ["users", "Nutzer"],
                ["apps", "Kreditanfragen"],
              ...
              <button
                ...
                type="button"
                onClick={() => setTab(key)}
                 className={`-mb-px min-h-11 shrink-0 border-b-2 px-4 py-2 text-[14px] transition-colors ${
                  tab === key
