  ...
  return (
    <div className="min-h-screen bg-[#f4f5f6]">
      <header className="bg-white shadow-header-strong">
        <div className="mx-auto grid min-h-[60px] max-w-[1200px] grid-cols-[minmax(0,1fr)_auto] items-center gap-3 px-4 py-2 md:flex md:h-[60px] md:justify-between md:px-6 md:py-0">
          ...
          <div className="flex shrink-0 items-center gap-3">
            ...
            <Button variant="outline" onClick={handleSignOut} className="h-11 text-[14px]">
              Abmelden
            </Button>
          </div>
        </div>
      ...
      <main className="mx-auto max-w-[1200px] overflow-hidden px-4 py-6 md:px-6 md:py-10">
