export function Logo({ className = "h-auto w-[170px]" }: { className?: string }) {
  return (
    ...
    >
      ...
      <text x="22" y="90" fill="#F4C430" fontFamily="Arial, sans-serif" fontSize="19">★★★★★</text>
      <text x="126" y="90" fill="#171717" fontFamily="Roboto, Arial, sans-serif" fontSize="17" fontWeight="700">4,9</text>
    </svg>
  );
}
